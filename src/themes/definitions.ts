...
const extras: Theme[] = [
  ...
  mk({
    ...
    fg: "#e8e8e8", fgMuted: "#9a9a9a", fgDim: "#646464",
    border: "#262626", borderStrong: "#3a3a3a",
    accent: "#a8a8a8", accentFg: "#0a0a0a",
    success: "#7fbf7f", warning: "#d8a85a", danger: "#d97070", dangerFg: "#0a0a0a", info: "#7faecf",
  ...
  mk({
    ...
    fg: "#f0e7ff", fgMuted: "#a99ad0", fgDim: "#6f6190",
    border: "#3a2e5e", borderStrong: "#5b4787",
    accent: "#d566ff", accentFg: "#15101f",
    success: "#5fff9b", warning: "#ffc857", danger: "#ff5c8a", dangerFg: "#15101f", info: "#5cc8ff",
  ...
  mk({
    ...
    accent: "#4589ff", accentFg: "#161616",
    success: "#42be65", warning: "#f1c21b", danger: "#fa4d56", dangerFg: "#161616", info: "#33b1ff",
  ...
  mk({
    ...
    fg: "#dde6f0", fgMuted: "#8b97ad", fgDim: "#5b6880",
    border: "#202c40", borderStrong: "#34425a",
    accent: "#5ec6f9", accentFg: "#0c1019",
    success: "#6ddc8b", warning: "#f7c46a", danger: "#ff5d5d", dangerFg: "#0c1019", info: "#5ec6f9",
  ...
  mk({
    ...
    fg: "#c0caf5", fgMuted: "#9aa5ce", fgDim: "#626b9b",
    border: "#2a2f48", borderStrong: "#3b4261",
    accent: "#bb9af7", accentFg: "#1a1b26",
    success: "#9ece6a", warning: "#e0af68", danger: "#f7768e", dangerFg: "#1a1b26", info: "#7dcfff",
  ...
  mk({
    ...
    fg: "#c9d1d9", fgMuted: "#8b949e", fgDim: "#616876",
    border: "#30363d", borderStrong: "#484f58",
    accent: "#58a6ff", accentFg: "#0d1117",
    success: "#3fb950", warning: "#d29922", danger: "#f85149", dangerFg: "#0d1117", info: "#58a6ff",
  ...
  mk({
    ...
    fg: "#e8e9ff", fgMuted: "#a0a4d6", fgDim: "#6368a0",
    border: "#262d54", borderStrong: "#3a4280",
    accent: "#9d6cff", accentFg: "#101327",
    success: "#5fffba", warning: "#ffcd5e", danger: "#ff5e86", dangerFg: "#101327", info: "#5ec3ff",
  ...
  mk({
    ...
    fg: "#c0caf5", fgMuted: "#a9b1d6", fgDim: "#68719f",
    border: "#343a52", borderStrong: "#414868",
    accent: "#7dcfff", accentFg: "#1f2335",
    success: "#9ece6a", warning: "#e0af68", danger: "#f7768e", dangerFg: "#1f2335", info: "#7dcfff",
  ...
  mk({
    ...
    fg: "#ffe6e6", fgMuted: "#d49494", fgDim: "#8f5454",
    border: "#3d1d1d", borderStrong: "#5e2929",
    accent: "#ff5c5c", accentFg: "#1a0808",
    success: "#ffac5c", warning: "#ffe35c", danger: "#ff3838", dangerFg: "#1a0808", info: "#ff8a5c",
  ...
  mk({
    ...
    fg: "#dee5ed", fgMuted: "#9aa6b8", fgDim: "#5e6e82",
    border: "#283342", borderStrong: "#3a475a",
    accent: "#f49b3a", accentFg: "#0e141b",
    success: "#7ec48f", warning: "#f4c64a", danger: "#df616a", dangerFg: "#0e141b", info: "#5db8d9",
  ...
  mk({
    ...
    fg: "#dcdcdc", fgMuted: "#878787", fgDim: "#5e5e5e",
    border: "#1c1c1c", borderStrong: "#303030",
    accent: "#00ff88", accentFg: "#000000",
    success: "#00ff88", warning: "#ffce4f", danger: "#ff3a4f", dangerFg: "#000000", info: "#00d2ff",
  ...
  mk({
    ...
    success: "#5cff8b", warning: "#ffd05c", danger: "#ff6b94", dangerFg: "#0d1b1e", info: "#5cffe8",
  ...
  mk({
    ...
    fg: "#ebe8ff", fgMuted: "#9d9ad0", fgDim: "#636196",
    border: "#2b2746", borderStrong: "#403c69",
    accent: "#a78bfa", accentFg: "#0e0d1a",
    success: "#5fffa3", warning: "#ffd95c", danger: "#ff5c7e", dangerFg: "#0e0d1a", info: "#5cc8ff",
  ...
  mk({
    ...
    fg: "#cae3ff", fgMuted: "#8aa6cc", fgDim: "#51698b",
    border: "#1d2a47", borderStrong: "#2e4470",
    accent: "#00d9ff", accentFg: "#0a0e1a",
    success: "#5cffaf", warning: "#ffce4f", danger: "#ff4f7a", dangerFg: "#0a0e1a", info: "#00d9ff",
  ...
  mk({
    ...
    fg: "#dde0ff", fgMuted: "#9498d6", fgDim: "#5a5f9f",
    border: "#252852", borderStrong: "#3b407c",
    accent: "#7c5cff", accentFg: "#000000",
    success: "#5fffb1", warning: "#ffcc5f", danger: "#ff5d8a", dangerFg: "#0c0d20", info: "#5fc4ff",
  ...
  mk({
    ...
    fg: "#dadde3", fgMuted: "#9097a4", fgDim: "#646b7b",
    border: "#2f3540", borderStrong: "#444c5a",
    accent: "#ff9933", accentFg: "#171a21",
    success: "#7fc28d", warning: "#e6c25a", danger: "#e85a5a", dangerFg: "#171a21", info: "#5db5d9",
  ...
  mk({
    ...
    fg: "#cce0f4", fgMuted: "#7ea2c4", fgDim: "#426587",
    border: "#003366", borderStrong: "#005599",
    accent: "#22aaff", accentFg: "#000c18",
    success: "#3fffae", warning: "#ffcc44", danger: "#ff5577", dangerFg: "#000c18", info: "#22aaff",
  ...
  mk({
    ...
    fg: "#2a2a2a", fgMuted: "#5e5950", fgDim: "#6a665d",
  ...
  mk({
    ...
    fg: "#4c4f69", fgMuted: "#626579", fgDim: "#5e6779",
    border: "#bcc0cc", borderStrong: "#7c7f93",
    accent: "#7287fd", accentFg: "#000000",
  ...
  mk({
    ...
    fg: "#252422", fgMuted: "#5c5b58", fgDim: "#6c6a64",
    border: "#d4ceb6", borderStrong: "#a39e89",
    accent: "#cc7a3b", accentFg: "#000000",
